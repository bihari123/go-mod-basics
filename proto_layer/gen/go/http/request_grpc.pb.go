...
type HttpServiceClient interface {
	...
	Put(ctx context.Context, in *PostRequest, opts ...grpc.CallOption) (*PostResponse, error)
}
...
func (c *httpServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/proto.HttpService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *httpServiceClient) Put(ctx context.Context, in *PostRequest, opts ...grpc.CallOption) (*PostResponse, error) {
	out := new(PostResponse)
	err := c.cc.Invoke(ctx, "/proto.HttpService/Put", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HttpServiceServer interface {
	...
	Put(context.Context, *PostRequest) (*PostResponse, error)
...
func (UnimplementedHttpServiceServer) Put(context.Context, *PostRequest) (*PostResponse, error) {
...
func _HttpService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.HttpService/Get",
	}
...
func _HttpService_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HttpServiceServer).Put(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.HttpService/Put",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HttpServiceServer).Put(ctx, req.(*PostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HttpService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Put",
			Handler:    _HttpService_Put_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "http/request.proto",
}
